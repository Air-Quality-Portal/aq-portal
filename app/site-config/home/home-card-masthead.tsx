...
export const MOCK_CARD_MASTHEAD: CardProps<typeof AppLink> = {
  ...
  colorMode: "brand",
  description:
    "AIR4US is a multi-agency initiative, integrating authoritative air-quality data to support local action and evidence-based decisions.",
  image: (
    <AppVideo
  ...
  title: (
    <h1 className="font-heading-2xl text-light text-white margin-0">
      A unified <span className="text-accent-cool">air-quality</span> data platform for decision
      making
    </h1>
  ),
};
