...
export const TOOLS: ToolContent[] = [
  ...
  },
  {
    ...
    thumbnailImage: {
      ...
      alt: "AirData website to access EPA outdoor air-quality monitoring data",
      attribution: "EPA",
  ...
  },
  {
    ...
    thumbnailImage: {
      ...
      alt: "AirNow Tech website, where air-quality organizations provide data and forecasts to the AirNow system",
      attribution: "EPA",
  ...
  },
  {
    ...
    thumbnailImage: {
      ...
      alt: "The current and forecasted AQI values for Morrisville, NC, in the EPA AirNow application",
      attribution: "EPA",
  ...
  },
  {
    ...
    thumbnailImage: {
      ...
      alt: "COBRA Web Edition tool for estimating the air quality and health benefits of different emission scenarios",
      attribution: "EPA",
  ...
  },
  {
    ...
    thumbnailImage: {
      ...
      alt: "EMBERS tool displaying model output, Ozone Fire Impact Maps for the Southeast, on July 21, 2021",
      attribution: "EPA",
      attributionLink:
  ...
  },
  {
    ...
    thumbnailImage: {
      ...
      alt: "Bar chart showing national pollutant emissions (tons) by NEI year from 2008 to 2020",
      attribution: "EPA",
