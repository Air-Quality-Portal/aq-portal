...
export const NOAA_HMS_FIRE_SMOKE: DatasetContent = {
  ...
  metadata: {
    ...
    fields: {
      ...
      spatialResolution: { label: "Spatial Resolution", value: "Point / polygon" },
      dataFormat: { label: "Data Format", value: "WFS, KML, Shapefile, Text" },
      versionHistory: {
        label: "Version History",
        value:
          "HMS Fire and Smoke data was incorporated into AIR4US in September 2026, including historical data dating from Jan 1, 2020 onward.",
      },
    },
  },
  actions: {
  ...
  citation: {
    ...
    text: "National Oceanic and Atmospheric Administration. (Year). Hazard Mapping System (HMS) fire and smoke product [Data set]. NOAA Office of Satellite and Product Operations. https://www.ospo.noaa.gov/products/land/hms.html",
  },
  relatedDatasets: {
